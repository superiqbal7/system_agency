						...
						<div>
							...
							<div className="img-box">
								<a href={`${url}/${image.slug}`}>
									<div
										className=""
										className={image.is_requested ? "image_text_faded" : ""}
									>
										<img
											key={image.slug}
							...
							{image.is_requested ? (
								...
								<div className="top-right top-right-fix">
									...
									<button onClick={() => this.requestImage(i)}>
										<Link className="">ADD TO PACKAGE</Link>
									</button>
								</div>
							)}
						</div>
								...
								<div className="men-dropdown">
									<div className="dropdown-content">
										<div className="flex justify-center">
											<button
												onClick={() => {
													this.genderImages("men", false);
													this.setState({
														...this.state,
														currentActive: "men image",
														isActiveMen: true,
														isActiveWomen: false,
													});
												}}
										...
										<div className="flex justify-center left">
											...
											<button
												onClick={() => {
													...
													this.setState({
														...this.state,
														currentActive: "women development",
														isActiveMen: false,
														isActiveWomen: true,
													});
												}}
						...
						<div class="modal-content">
							<div class="modal-body">
								...
								<form action="">
									...
									/>
									<textarea
										className="input-line textarea-input-line"
